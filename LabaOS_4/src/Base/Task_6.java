    ...
    public static void main(String[]args){
        ...
        Thread play = new Thread(() -> {
            ...
            while (!mem.CheckWin()){
                  synchronized (mem) {
                      int x = (int) (0 + Math.random() * 10);
                      int y = (int) (0 + Math.random() * 10);
                      while (!Shot(mem.first, x, y)) {
                          x = (int) (0 + Math.random() * 10);
                          y = (int) (0 + Math.random() * 10);
                      }
                      x = (int) (0 + Math.random() * 10);
                      y = (int) (0 + Math.random() * 10);
                      while (!Shot(mem.second, x, y)) {
                          x = (int) (0 + Math.random() * 10);
                          y = (int) (0 + Math.random() * 10);
                      }
                  }
                i++;
                System.out.println("FirstField_Turn " + i);
                printField(mem.first.field);
                System.out.println("SecondField_Turn "+ i);
                printField(mem.second.field);
                try {
                    Thread.sleep(10);
